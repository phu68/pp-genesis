...
// add_action( 'wp_enqueue_scripts', 'phamphu_enqueue_styles' );
// 	 function phamphu_enqueue_styles() {
//  		  wp_enqueue_style( 'parent-style', get_template_directory_uri() . '/pp_customs.css' ); 
//  		  } 
...
// //* Use Font icon for Home breadcrumb
// add_filter ( 'genesis_home_crumb', 'gk_breadcrumb_home_icon' ); 
// function gk_breadcrumb_home_icon( $crumb ) {
